...
const ui = {
  en: {
    heading: 'Get Results Without Hiring More Staff',
    highlights: [
  ...
  de: {
    heading: 'Ergebnisse erzielen – ohne mehr Personal einzustellen',
    highlights: [
      'Lass Backlinks, Content und andere Leistungen erledigen – ohne dein Team zu vergrößern.',
      'Flexible Einzelleistungen und Pakete.',
      'Managed-SEO-Service ab nur 500 EUR/Monat.',
      'Bewiesene Ergebnisse in verschiedenen Nischen.',
    ],
    cta: 'KOSTENLOSE BERATUNG BUCHEN',
    ctaHref: '/de/consultation',
  },
}

export default function CtaSection({ locale = 'en' }: { locale?: 'en' | 'de' }) {
  const t = ui[locale]
